          ...
          <div className="relative z-10 flex h-full flex-col">
            ...
            >
              <div className="text-4xl font-bold text-white">
                JobBoost<span className="text-blue-200">AI</span>
              </div>
            </Link>
            ...
            <div className="mb-12 mt-10">
              ...
              <p className="text-lg leading-relaxed text-blue-100">
                Sign in to access powerful AI-driven tools designed to optimize
                your job search, enhance your resume, and boost your career
                opportunities.
              </p>
          ...
          <div className="mx-auto max-w-md">
            ...
            <div className="mt-10">
              ...
              <div className="mt-6">
                <Link
                  href="/auth/signup"
                  className="flex w-full justify-center rounded-lg border border-blue-300 bg-white px-4 py-3 text-sm font-medium text-blue-600 shadow-sm transition-all duration-300 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:border-blue-700 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700"
                >
                  Create an account
                </Link>
              </div>
